...
/**
 * Object for handling Item states
 */
final class ItemStates implements Collection
{
    /**
    ...
    protected static function createFrom(array $elements)
    {
        foreach ($elements as $el){
            if (!($el instanceof ItemState)) {
                throw new \InvalidArgumentException("cannot add type".$el);
            }
        }
    ...
    public static function createFromDonationItems(array $donationItems)
    {
        ...
        return self::createFrom($donationItems);
    }
    ...
    public function set($key, $value)
    {
        if (!($value instanceof ItemState)) {
            throw new \InvalidArgumentException("cannot add type".$value);
        }
    ...
    {
        if (!($element instanceof ItemState)) {
            throw new \InvalidArgumentException("cannot add type".$element);
        }
