...
final class Version20200317102506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO donation_requests_items (donation_request_id, item_id, quantity) SELECT id AS donation_request_id, donation_item_id AS item_id, quantity FROM donation_request WHERE donation_item_id IS NOT NULL;');
