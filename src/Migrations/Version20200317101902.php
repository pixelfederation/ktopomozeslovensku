...
final class Version20200317101902 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE donation_requests_items (donation_request_id INT NOT NULL, item_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_DBAD424DE04907ED (donation_request_id), INDEX IDX_DBAD424D126F525E (item_id), PRIMARY KEY(donation_request_id, item_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE donation_requests_items ADD CONSTRAINT FK_DBAD424DE04907ED FOREIGN KEY (donation_request_id) REFERENCES donation_request (id)');
        $this->addSql('ALTER TABLE donation_requests_items ADD CONSTRAINT FK_DBAD424D126F525E FOREIGN KEY (item_id) REFERENCES donation_item (id)');
